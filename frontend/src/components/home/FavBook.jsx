    ...
    <div className="px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12">
      ...
      <div className="md:w-1/2 space-y-6">
        ...
        <p className="mb-10 text-lg md:w-5/6">
          ...
          temporibus velit autem earum dolores. Doloremque nihil magnam earum
          itaque quidem, velit ullam mollitia, facilis praesentium ut
          reprehenderit quasi, repellat deserunt!
        </p>
        <div className="flex flex-col sm:flex-row justify-between gap-6 md:w-3/4 my-14">
          <div>
            <h3 className="text-3xl font-bold">700+</h3>
            <p className="text-base">Booking Listing</p>
          </div>
          <div>
